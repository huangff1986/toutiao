...
import HotChannel from './HotChannel/HotChannel'
    ...
    return (
      <div className='sliderPop'>
        <div className='warpper'>
          ...
          <MyChannel data={this.props.data} removeChannel={this.props.removeChannel}/>
          <HotChannel data={this.props.data} addChannel={this.props.addChannel}/>
        </div>
      </div>
    )
  }
